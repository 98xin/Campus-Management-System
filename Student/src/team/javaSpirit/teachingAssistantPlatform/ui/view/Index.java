...
public class Index extends JFrame {
	...
	public void setBroadcastingMenu() {
		JLabel menu4 = new JLabel("<html>课堂管理系统学生端</html>");
		menu4.setBounds(290, 28, 200, 99);
		menu4.setFont(new Font("宋体", Font.BOLD, 20));
	...
	public void setTime() {
		...
		if (scs.findCurrentCourse(Constant.myStudent.getSid())) {
			...
			time = new JLabel("<html>第" + w + "周<br><br>" + cname + "</html>");
			time.setToolTipText(cname1);
			// 启动定时任务
			new SignTimerTask();
		} else {
