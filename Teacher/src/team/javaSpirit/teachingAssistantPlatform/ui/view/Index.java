...
import team.javaSpirit.teachingAssistantPlatform.ui.event.DownLoadListener;
...
public class Index extends JFrame {
	...
	public void centerContent() {
		...
		datelabel.setFont(new Font("宋体", Font.BOLD, 16));
		datelabel.setHorizontalAlignment(SwingConstants.CENTER);
		datelabel.setBounds(16, 5, 100, 30);
		contentpl.add(datelabel);
		//课程
		...
		if (cs.findCurrentCourse(tid)) {
			...
			course = new JLabel("课程："+Constant.cid + "   " +cname);
		} else {
			course = new JLabel("目前没课");
		}
		course.setForeground(new Color(255, 255, 255));
		course.setFont(new Font("宋体", Font.BOLD, 16));
		course.setHorizontalAlignment(SwingConstants.CENTER);
		course.setBounds(180, 5, 300, 30);
		contentpl.add(course);
		//导出
		JLabel down = new JLabel("");
		down.setIcon(new ImageIcon("image/down.png"));
		down.setBounds(700, 5, 30, 30);
		contentpl.add(down);
		// 签到情况的服务
		StudentSignInServiceImpl ss = new StudentSignInServiceImpl();
		// 添加事件监听
		DownLoadListener download = new DownLoadListener(this, ss);
		down.addMouseListener(download);
		...
		table_1.setRowHeight(40);// 设置每行的高度
	...
	public void setTeacherInfo() {
		...
		JLabel label_11 = new JLabel("<html>教师编号：<br><br>" + tId + "<br><br>姓名：<br><br>"+ tName +"</html>");
	...
	public void setTime() {
		...
		lblNewLabel1 = new JLabel("<html>课堂管理系统教师端</html>");
		...
		if (cs.findCurrentCourse(tid)) {
			...
			lblNewLabel.setToolTipText(cname1);
		} else {
	...
	public void selectstuScore() {
		...
		comboBox_2.setBounds(580, 5, 200, 30);
...
//		uploads.setIcon(new ImageIcon("image/up.png"));
//		uploads.setBounds(730, 4, 50, 36);
...
//		uploads.addMouseListener(new UploadMouseListener(this));
		...
		table_2.setRowHeight(40);// 设置每行的高度
