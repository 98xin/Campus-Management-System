...
import team.javaSpirit.teachingAssistantPlatform.ui.event.TeacherModifyActionListener;
...
public class Modify extends JFrame {
	...
	public void setLogo() {
		...
		// logo文字
		JLabel logoword = new JLabel("课堂管理系统教师端");
	...
	public void setConfirm() {
		...
		confirm.addActionListener(new TeacherModifyActionListener(this));
	}
